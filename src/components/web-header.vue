  ...
  <el-drawer
    ...
    :with-header="false">
      ...
      <el-tab-pane label="我的评论" name="1">
        <span ><i class="el-icon-message-solid"></i> 我的评论</span>
              ...
              <el-card>
                ...
                <span class="left p1">
                  ...
                  <div class="rightTop">
                    ...
                    <el-tag style="cursor: pointer;"  v-on:click="goSource(comment)">{{comment.sourceName}}</el-tag>
                  </div>
                ...
                <div class="commentList">
                  ...
                  <span class="right p1">
                      ...
                      <div class="rightTop">
                        ...
                        <el-tag style="cursor: pointer;"  v-on:click="goSource(reply)">{{reply.sourceName}}</el-tag>
                      </div>
      ...
      <el-tab-pane label="我的点赞" name="3">
        <span ><i class="el-icon-star-on"></i> 我的点赞</span>
        <div style="width: 100%; height: 840px;overflow:auto">
          <el-timeline>
            <el-timeline-item v-for="praise in praiseList" :key="praise.uid" :timestamp="timeAgo(praise.createTime)" placement="top">
              <el-card>
                <span>点赞</span><el-tag type="warning" style="cursor: pointer" v-if="praise.blog" v-on:click="goToInfo(praise.blog.uid)">{{praise.blog.title}}</el-tag>
              </el-card>
            </el-timeline-item>
      ...
      <el-tab-pane label="我的反馈" name="4">
        <span ><i class="el-icon-phone"></i> 我的反馈</span>
              ...
              <el-card class="feedbackCard">
                ...
                <div class="item">
                  ...
                  <span class="content">
                    ...
                    <el-tag  :key="item.uid" :type="item.listClass" v-if="feedbackItem.feedbackStatus == item.dictValue">{{item.dictLabel}}</el-tag>
                    </template>
                  </span>
                </div>
      ...
      <el-tab-pane label="申请友链" name="5">
        <span ><i class="el-icon-share"></i> 申请友链</span>
...
<!--        </el-form>-->
      ...
      <el-tab-pane label="修改密码" name="6">
        <span ><i class="el-icon-s-tools"></i> 修改密码</span>
        <el-collapse v-model="activeNames">
...
<script>
  import AvatarCropper from '@/components/AvatarCropper/AvatarCropperIndex.vue'
  import LoginBox from "@/components/LoginBox";
  // vuex中有mapState方法，相当于我们能够使用它的getset方法
  import {mapMutations} from 'vuex';
  import {getWebConfig, getWebNavbar} from "@/api";
